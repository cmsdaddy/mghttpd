    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main', models.IntegerField(blank=True, default=0, help_text='设备主索引号', null=True)),
                ('subordinate', models.IntegerField(blank=True, default=0, help_text='设备次索引号', null=True)),
